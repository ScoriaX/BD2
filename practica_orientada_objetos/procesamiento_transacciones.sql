...
('CTA-002', 'Maria Garcia', 3500.00),
('CTA-003', 'Carlos Lopez', 1200.00),
('CTA-004', 'Ana Martinez', 8900.00),
...
BEGIN;
	...
	-- ¿Qué observan? El cambio realizado no es visible en otras sesiones porque no se hizo el COMMIT
